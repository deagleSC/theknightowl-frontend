...
export const metadata: Metadata = {
  ...
  description:
    "The Knight Owl connects young chess players with expert coaches, offering real-time collaboration, game analysis, and seamless booking to help players unlock their full potential.", // Updated description
  keywords:
    "chess, chess players, chess coaches, online chess, chess training, learn chess, chess improvement, young chess players", // SEO-friendly keywords
  ...
  openGraph: {
    ...
    description:
      "The Knight Owl connects young chess players with expert coaches and offers powerful tools for chess improvement.", // OpenGraph description
  ...
  twitter: {
    ...
    description:
      "The Knight Owl connects young chess players with expert coaches to help them improve their skills and reach new heights in the game.", // Twitter description
